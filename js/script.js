function Un_CheckThisBox(strchk,index_checked){
	box = eval(strchk + index_checked);
...
TINY.table=function(){
	...
	sorter.prototype.init=function(){
		...
		if(this.p.colddid){
			d=T$(this.p.colddid);
			var o=document.createElement('option'); o.value=-1; o.innerHTML='All Fields'; d.appendChild(o)
		}
		for(i;i<t.w;i++){
