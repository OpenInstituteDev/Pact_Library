...
function imageSlideShow()
{
  ...
  if(count<img.length){
  document.getElementById("myImage").src = "img/"+img[count]+".png";
  count++;
  }else{
  count=0;
  //show image after count equal array size
  document.getElementById("myImage").src = "img/image5.png";
  }
  //Set Timeout for image slide show 
